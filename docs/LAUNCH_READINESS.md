...
| ----------------------------------------- | ----------------------------------------------------------------- | ------------------------- |
| Local release gates                       | Passed latest local hardening sweep on 2026-06-27                 | Yes                       |
| Local API/performance baselines           | Passed latest local baseline rerun on 2026-06-27                  | Yes                       |
| Local page-load baseline                  | Passed latest local baseline rerun on 2026-06-27                  | Yes                       |
| Local backup/restore proof                | Passed latest local baseline rerun on 2026-06-27                  | Yes                       |
...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| Latest release gate sweep                          | `format:check`, `lint`, `security:check`, `api:route-drift:check`, `typecheck`, `test`, `test:coverage`, `smoke`, `build`, `audit --prod`, `git diff --check` | This document                                 |
...
Latest local release gate sweep: 2026-06-27.
...
| `rtk corepack pnpm run test`                  | Pass, 99 passed and 4 skipped                                                                        |
| `rtk corepack pnpm run test:e2e:api`          | Pass, 4 passed across main, boundary, and concurrency API e2e specs                                  |
| `rtk corepack pnpm run smoke`                 | Pass, API and browser e2e smoke checks passed                                                        |
| `rtk corepack pnpm run test:coverage`         | Pass, 99 passed and 4 skipped; V8 coverage report emitted                                            |
| `rtk corepack pnpm run build`                 | Pass                                                                                                 |
| `rtk corepack pnpm run security:check`        | Pass, no committed secrets and no high-severity audit failures; remaining advisories below high gate |
