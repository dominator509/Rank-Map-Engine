              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-1.5 max-h-48 overflow-y-auto">
                    {ALL_EVENTS.map((event) => (
                      <label
                        key={event}
                        className="flex items-center gap-2 text-xs cursor-pointer p-1 hover:bg-muted rounded"
                      >
                        <Checkbox
                ...
                <DialogFooter>
                  <Button
                    ...
                    disabled={!url || createWebhook.isPending}
                    className="w-full"
                  >
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <Switch
                        checked={ep.isActive}
                        onCheckedChange={(v) => toggleActive.mutate({ id: ep.id, isActive: v })}
                      />
                      <Button
                        variant="outline"
                        size="sm"
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (confirm("Delete webhook?")) deleteWebhook.mutate(ep.id);
                        }}
                      >
